...
if (route.query.menu == "beverages") {
  switchTab({ slug: "beverages", title: "Beverages" });
}
  ...
  <main>
    <section class="h-[300px] lg:h-[500px] w-full relative">
      <div class="h-full w-full bg-black/25">
        <img
          src="/assets/img/menu-head.png"
          class="object-cover h-full w-full mix-blend-darken"
        />
      </div>

      <div
        class="flex items-center justify-center z-50 absolute top-0 left-0 right-0 bottom-0"
      >
        <h1
    ...
    <section class="py-12 bg-[#1C1C1C]">
      <div class="max-w-6xl mx-auto px-4 2xl:px-0">
        ...
        <div class="w-full">
          <h1 class="text-white text-[36px] text-rosarivo text-center py-12">
            {{ tab.title }}
          </h1>
          ...
          <div v-if="!isLoading">
                ...
                <div class="relative group">
                  ...
                  >
                    <div class="absolute bottom-2 left-0 px-2">
                      <h1
                        class="text-white font-sans font-semibold text-[18px]"
                      >
                        {{ rupiah(item.price) }}
                      </h1>

                      <h1
                        class="text-white font-rosarivo font-bold text-[20px]"
                      >
                        {{ item.title }}
                      </h1>
            ...
            <div
              class="font-sans mt-4 text-white"
              v-if="!isLoading && list.length > 0"
            >
